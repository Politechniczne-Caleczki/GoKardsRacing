...
namespace JigLibX.Physics
{
    ...
    public class PhysicsSystem
    {
        ...
        {
            get { return new ReadOnlyCollection<Body>(bodies); }
        }
        ...
        {
            get { return new ReadOnlyCollection<Constraint>(constraints); }
        }
        ...
        {
            get { return new ReadOnlyCollection<Controller>(controllers); }
        }
